...
- **Ejecución:**
  ...
  - Emulador o dispositivo físico con Android 8.0 o superior (en mi caso active la opción de "Depuración por WiFi")
...
- Descripción del flujo principal:
  ...
  6. En Perfil:
     ...
     - ver su nombre y correo en casillas
